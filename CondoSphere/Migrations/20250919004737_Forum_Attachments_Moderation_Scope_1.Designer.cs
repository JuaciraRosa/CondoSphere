...
namespace CondoSphere.Migrations
{
    ...
    [Migration("20250919004737_Forum_Attachments_Moderation_Scope_1")]
    partial class Forum_Attachments_Moderation_Scope_1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CondoSphere.Models.Quota", b =>
                {
                    ...
                    b.Property<string>("DebtorEmail")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DebtorName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DebtorUserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CondoSphere.Models.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 19, 0, 47, 36, 775, DateTimeKind.Unspecified).AddTicks(9930), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("CondoSphere.Models.ForumSubscription", b =>
                {
                    b.HasOne("CondoSphere.Models.ForumTopic", null)
            ...
            modelBuilder.Entity("CondoSphere.Models.ForumTopic", b =>
                {
                    b.HasOne("CondoSphere.Models.ForumCategory", "Category")
                        .WithMany("Topics")
