...
namespace CondoSphere.Migrations
{
    ...
    [Migration("20250918233852_Forum_Attachments_Moderation_Scope")]
    partial class Forum_Attachments_Moderation_Scope
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CondoSphere.Models.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 18, 23, 38, 51, 317, DateTimeKind.Unspecified).AddTicks(401), new TimeSpan(0, 0, 0, 0, 0)),
