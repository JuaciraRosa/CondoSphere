...
namespace CondoSphere.Migrations
{
    ...
    [Migration("20250916164150_AddEmailTogglesToSystemSettings")]
    partial class AddEmailTogglesToSystemSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CondoSphere.Models.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 16, 16, 41, 49, 491, DateTimeKind.Unspecified).AddTicks(8451), new TimeSpan(0, 0, 0, 0, 0)),
