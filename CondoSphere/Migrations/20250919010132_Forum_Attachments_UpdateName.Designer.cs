...
namespace CondoSphere.Migrations
{
    ...
    [Migration("20250919010132_Forum_Attachments_UpdateName")]
    partial class Forum_Attachments_UpdateName
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CondoSphere.Models.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 19, 1, 1, 30, 698, DateTimeKind.Unspecified).AddTicks(5384), new TimeSpan(0, 0, 0, 0, 0)),
