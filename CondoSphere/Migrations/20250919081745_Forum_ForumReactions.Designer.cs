...
namespace CondoSphere.Migrations
{
    ...
    [Migration("20250919081745_Forum_ForumReactions")]
    partial class Forum_ForumReactions
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CondoSphere.Models.SystemSettings", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            UpdatedAt = new DateTimeOffset(new DateTime(2025, 9, 19, 8, 17, 44, 399, DateTimeKind.Unspecified).AddTicks(8124), new TimeSpan(0, 0, 0, 0, 0)),
